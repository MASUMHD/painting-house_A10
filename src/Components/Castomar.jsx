          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg border-2 border-gray-600 rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Painting House Store provides exceptional service, quality
                products, and expert advice for all your painting needs. Highly
                recommended!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg border-2 border-gray-600 rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Painting House Store exceeded my expectations with their
                professionalism, timely delivery, and affordable prices. A
                top-notch choice for painting supplies!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg border-2 border-gray-600 rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Painting House Store offers top-quality paints, tools, and
                outstanding customer service. Trustworthy and reliable for all
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg border-2 border-gray-600 rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Painting House Store is a fantastic option for all your painting
                needs, providing great products and excellent customer service.
                Highly recommended!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
